...
export default function Navbar() {
  ...
  return (
    <nav
      className={`px-8 py-4 flex items-center justify-between transition-all z-50 ${isHome ? "absolute top-0 left-0 right-0 bg-transparent" : "bg-white border-b border-gray-100 shadow-sm"}`}
    >
      {/* Logo */}
      <Link href="/" className="flex items-center gap-2 group">
        <div
          className={`w-8 h-8 rounded-lg flex items-center justify-center ${isHome ? "bg-white/20" : "bg-[#7C5CBF]"}`}
        >
