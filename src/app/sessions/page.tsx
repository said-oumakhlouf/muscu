...
export default function SessionsPage() {
  ...
  if (role === "admin" || role === "coach") {
    ...
    const sorted = [...filtered].sort((a, b) => {
      const diff =
        order[getSessionStatus(a.scheduledAt)] -
        order[getSessionStatus(b.scheduledAt)];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 mt-1">
              {coachSessions.length} séance
              {coachSessions.length !== 1 ? "s" : ""} · {clients.length} client
              {clients.length !== 1 ? "s" : ""}
            </p>
          </div>
          ...
          {sorted.length === 0 ? (
            <div className="text-center py-20 text-gray-400">
              ...
              <p className="text-sm mt-1">
                Créez des séances depuis la fiche d&apos;un client
              </p>
            </div>
          ) : (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {sortedMySessions.length === 0 ? (
          <div className="text-center py-20 text-gray-400">
            ...
            <p className="text-sm mt-1">
              Votre coach vous assignera des séances bientôt
            </p>
          </div>
        ) : (
          <div className="space-y-3">
